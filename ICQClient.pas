...
type
  ...
  TOnUserInfoReply = procedure(Sender: TObject; RequestId, Code: Word; Data, ExData: string) of object;
  TOnICBMReply = procedure(Sender: TObject; RequestId, ECode, SubECode: Word) of object;
  ...
  private
    ...
    FErrLang: TICQLangType;
    FOnUserInfoReply: TOnUserInfoReply;
    FOnICBMReply: TOnICBMReply;
...
//    procedure HSnac1705(Flap: TFlapHdr; Snac: TSnacHdr; Pkt: PRawPkt);
    ...
    procedure HandleSRV_LOCATE_USER_INFO_REPLY(Flap: TFlapHdr; Snac: TSnacHdr; Pkt: PRawPkt);
    procedure HandleSRV_LOCATE_ERR(Flap: TFlapHdr; Snac: TSnacHdr; Pkt: PRawPkt);
    procedure HandleSRV_ICBM_ERR(Flap: TFlapHdr; Snac: TSnacHdr; Pkt: PRawPkt);
    procedure HandleSRV_BUCP_CHALLENGE(Flap: TFlapHdr; Snac: TSnacHdr; Pkt: PRawPkt);
    procedure HandleSRV_BUCP_REPLY(Flap: TFlapHdr; Snac: TSnacHdr; Pkt: PRawPkt);
    procedure HandleSRV_BUCP_ERR(Flap: TFlapHdr; Snac: TSnacHdr; Pkt: PRawPkt);
  ...
  public
    ...
    procedure UserInfoQuery2(SN: string; const RequestId: Word);
    procedure ICBMQuery(SN: string; const RequestId: Word);    
  published
    ...
    property OnUserInfoReply: TOnUserInfoReply read FOnUserInfoReply write FOnUserInfoReply;
    property OnICBMReply: TOnICBMReply read FOnICBMReply write FOnICBMReply;
  end;
  ...
  case Flap.ChID of
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          CreateCLI_BUCP_REQ_CHALLENGE(@pkt, FScreenName, FSeq);
          FSock.SendData(pkt, pkt.Len);
          //CreateCLI_IDENT(@pkt, ScreenName, FLPass, FSeq);
          //FSock.SendData(pkt, pkt.len);
        end else
        begin
    ...
    begin
      ...
      case Snac.Family of
        ...
        begin
          case Snac.SubType of
            $0001: HandleSRV_LOCATE_ERR(Flap, Snac, @pkt);
            $0006: HandleSRV_LOCATE_USER_INFO_REPLY(Flap, Snac, @Pkt);
          end;
        end;
        $03: //Family x03
        begin
        ...
        $04: //Family x04
          ...
          else if Snac.SubType = $0001 then
            HandleSRV_ICBM_ERR(Flap, Snac, @Pkt);
        $09: //Family x09
        begin
        ...
        begin
          case Snac.SubType of
            $0001: HandleSRV_BUCP_ERR(Flap, Snac, @Pkt);
            $0003: HandleSRV_BUCP_REPLY(Flap, Snac, @Pkt);
            $0007: HandleSRV_BUCP_CHALLENGE(Flap, Snac, @Pkt);
          end;
        end;
      end;
    end;
    ...
    begin
      ...
      if (not FLoggedIn) and (Flap.DataLen = 0) then
      begin
        FSock.Disconnect;
        if FSock.Host = '' then
        begin
...
procedure TICQClient.HandleSRV_LOCATE_USER_INFO_REPLY(Flap: TFlapHdr;
  Snac: TSnacHdr; Pkt: PRawPkt);
var
  OnlineResult, ExData: string;
const
  xStatuses: array[0..44] of
                          record
                            xUUID: string;
                            xValue: string
                          end = (
 (xUUID: #$01#$d8#$d7#$ee#$ac#$3b#$49#$2a#$a5#$8d#$d3#$d8#$77#$e6#$6b#$92; xValue: ' (angry)'),
 (xUUID: #$5a#$58#$1e#$a1#$e5#$80#$43#$0c#$a0#$6f#$61#$22#$98#$b7#$e4#$c7; xValue: ' (duck)'),
 (xUUID: #$83#$c9#$b7#$8e#$77#$e7#$43#$78#$b2#$c5#$fb#$6c#$fc#$c3#$5b#$ec; xValue: ' (yawn)'),
 (xUUID: #$e6#$01#$e4#$1c#$33#$73#$4b#$d1#$bc#$06#$81#$1d#$6c#$32#$3d#$81; xValue: ' (party)'),
 (xUUID: #$8c#$50#$db#$ae#$81#$ed#$47#$86#$ac#$ca#$16#$cc#$32#$13#$c7#$b7; xValue: ' (beer)'),
 (xUUID: #$3F#$B0#$BD#$36#$AF#$3B#$4A#$60#$9E#$EF#$CF#$19#$0F#$6A#$5A#$7F; xValue: ' (thinking)'),
 (xUUID: #$F8#$E8#$D7#$B2#$82#$C4#$41#$42#$90#$F8#$10#$C6#$CE#$0A#$89#$A6; xValue: ' (eating)'),
 (xUUID: #$80#$53#$7D#$E2#$A4#$67#$4A#$76#$B3#$54#$6D#$FD#$07#$5F#$5E#$C6; xValue: ' (tv)'),
 (xUUID: #$F1#$8A#$B5#$2E#$DC#$57#$49#$1D#$99#$DC#$64#$44#$50#$24#$57#$AF; xValue: ' (friends)'),
 (xUUID: #$1B#$78#$AE#$31#$FA#$0B#$4D#$38#$93#$D1#$99#$7E#$EE#$AF#$B2#$18; xValue: ' (coffee)'),
 (xUUID: #$61#$be#$e0#$dd#$8b#$dd#$47#$5d#$8d#$ee#$5f#$4b#$aa#$cf#$19#$a7; xValue: ' (music)'),
 (xUUID: #$48#$8e#$14#$89#$8a#$ca#$4a#$08#$82#$aa#$77#$ce#$7a#$16#$52#$08; xValue: ' (business)'),
 (xUUID: #$10#$7a#$9a#$18#$12#$32#$4d#$a4#$b6#$cd#$08#$79#$db#$78#$0f#$09; xValue: ' (camera)'),
 (xUUID: #$6f#$49#$30#$98#$4f#$7c#$4a#$ff#$a2#$76#$34#$a0#$3b#$ce#$ae#$a7; xValue: ' (funny)'),
 (xUUID: #$12#$92#$e5#$50#$1b#$64#$4f#$66#$b2#$06#$b2#$9a#$f3#$78#$e4#$8d; xValue: ' (phone)'),
 (xUUID: #$d4#$a6#$11#$d0#$8f#$01#$4e#$c0#$92#$23#$c5#$b6#$be#$c6#$cc#$f0; xValue: ' (games)'),
 (xUUID: #$60#$9d#$52#$f8#$a2#$9a#$49#$a6#$b2#$a0#$25#$24#$c5#$e9#$d2#$60; xValue: ' (college)'),
 (xUUID: #$63#$62#$73#$37#$a0#$3f#$49#$ff#$80#$e5#$f7#$09#$cd#$e0#$a4#$ee; xValue: ' (shoping)'),
 (xUUID: #$1f#$7a#$40#$71#$bf#$3b#$4e#$60#$bc#$32#$4c#$57#$87#$b0#$4c#$f1; xValue: ' (sick)'),
 (xUUID: #$78#$5e#$8c#$48#$40#$d3#$4c#$65#$88#$6f#$04#$cf#$3f#$3f#$43#$df; xValue: ' (sleeping)'),
 (xUUID: #$a6#$ed#$55#$7e#$6b#$f7#$44#$d4#$a5#$d4#$d2#$e7#$d9#$5c#$e8#$1f; xValue: ' (surfing)'),
 (xUUID: #$12#$d0#$7e#$3e#$f8#$85#$48#$9e#$8e#$97#$a7#$2a#$65#$51#$e5#$8d; xValue: ' (internet)'),
 (xUUID: #$ba#$74#$db#$3e#$9e#$24#$43#$4b#$87#$b6#$2f#$6b#$8d#$fe#$e5#$0f; xValue: ' (engineering)'),
 (xUUID: #$63#$4f#$6b#$d8#$ad#$d2#$4a#$a1#$aa#$b9#$11#$5b#$c2#$6d#$05#$a1; xValue: ' (typing)'),
 (xUUID: #$dd#$cf#$0e#$a9#$71#$95#$40#$48#$a9#$c6#$41#$32#$06#$d6#$f2#$80; xValue: ' (de3)'),
 (xUUID: #$b7#$08#$67#$f5#$38#$25#$43#$27#$a1#$ff#$cf#$4c#$c1#$93#$97#$97; xValue: ' (de2)'),
 (xUUID: #$63#$14#$36#$ff#$3f#$8a#$40#$d0#$a5#$cb#$7b#$66#$e0#$51#$b3#$64; xValue: ' (de1)'),
 (xUUID: #$16#$f5#$b7#$6f#$a9#$d2#$40#$35#$8c#$c5#$c0#$84#$70#$3c#$98#$fa; xValue: ' (china5)'),
 (xUUID: #$64#$43#$c6#$af#$22#$60#$45#$17#$b5#$8c#$d7#$df#$8e#$29#$03#$52; xValue: ' (china4)'),
 (xUUID: #$16#$0c#$60#$bb#$dd#$44#$43#$f3#$91#$40#$05#$0f#$00#$e6#$c0#$09; xValue: ' (china3)'),
 (xUUID: #$10#$11#$17#$c9#$a3#$b0#$40#$f9#$81#$ac#$49#$e1#$59#$fb#$d5#$d4; xValue: ' (china2)'),
 (xUUID: #$2c#$e0#$e4#$e5#$7c#$64#$43#$70#$9c#$3a#$7a#$1c#$e8#$78#$a7#$dc; xValue: ' (china1)'),
 (xUUID: #$E6#$01#$E4#$1C#$33#$73#$4B#$D1#$BC#$06#$81#$1D#$6C#$32#$3D#$82; xValue: ' (sex)'),             // rnq
 (xUUID: #$3F#$B0#$BD#$36#$AF#$3B#$4A#$60#$9E#$EF#$CF#$19#$0F#$6A#$5A#$7E; xValue: ' (smoke)'),           // rnq
 (xUUID: #$B7#$07#$43#$78#$F5#$0C#$77#$77#$97#$77#$57#$78#$50#$2D#$05#$71; xValue: ' (away)'),            // qip
 (xUUID: #$B7#$07#$43#$78#$F5#$0C#$77#$77#$97#$77#$57#$78#$50#$2D#$05#$72; xValue: ' (na)'),              // qip
 (xUUID: #$B7#$07#$43#$78#$F5#$0C#$77#$77#$97#$77#$57#$78#$50#$2D#$05#$73; xValue: ' (occupied)'),        // qip
 (xUUID: #$B7#$07#$43#$78#$F5#$0C#$77#$77#$97#$77#$57#$78#$50#$2D#$05#$74; xValue: ' (dnd)'),             // qip
 (xUUID: #$B7#$07#$43#$78#$F5#$0C#$77#$77#$97#$77#$57#$78#$50#$2D#$05#$75; xValue: ' (free for chat)'),   // qip
 (xUUID: #$B7#$07#$43#$78#$F5#$0C#$77#$77#$97#$77#$57#$78#$50#$2D#$05#$76; xValue: ' (at home)'),         // qip
 (xUUID: #$B7#$07#$43#$78#$F5#$0C#$77#$77#$97#$77#$57#$78#$50#$2D#$05#$77; xValue: ' (at work)'),         // qip
 (xUUID: #$B7#$07#$43#$78#$F5#$0C#$77#$77#$97#$77#$57#$78#$50#$2D#$05#$78; xValue: ' (lunch)'),           // qip
 (xUUID: #$B7#$07#$43#$78#$F5#$0C#$77#$77#$97#$77#$57#$78#$50#$2D#$05#$79; xValue: ' (evil)'),            // qip
 (xUUID: #$B7#$07#$43#$78#$F5#$0C#$77#$77#$97#$77#$57#$78#$50#$2D#$05#$70; xValue: ' (depression)'),      // qip
 (xUUID: #$B7#$07#$43#$78#$F5#$0C#$77#$77#$97#$77#$57#$78#$50#$2D#$07#$77; xValue: ' + birthday')         // qip
                                );

  SNAC_HEADER_FLAGS_OPT_TLV_PRESENT = $8000;

  procedure AddExData(Value: string);
  var
    NLINE: string;
  begin
    NLINE := #$0D#$0A;
    if ExData = '' then NLINE := '';
    ExData := ExData + NLINE + Value;
  end;

  function HandleUUIDSet(const UUID: string): string;
  var
    i: Word;
  begin
    for i := Low(xStatuses) to High(xStatuses) do
      if xStatuses[i].xUUID = UUID then
      begin
        Result := xStatuses[i].xValue;
        Exit;
      end;
    Result := '';
  end;

  procedure HandleTLVs(TLVBlock: TTLVBlock; OBlock: Boolean);
  var
    Data: Integer;
    DateTime: TDateTime;
    j: Word;
  begin
    if TLVBlock.L = 0 then Exit;
    case OBlock of
      True:
        case TLVBlock.T of
          $0003:
          begin
            Dec(Pkt^.Len, TLVBlock.L);
            AddExData(' *— Signed on: ' + DateTimeToStr(UnixToDateTime(GetInt(pkt, 4))));
          end;
          $0004:
          begin
            Dec(Pkt.Len, TLVBlock.L);
            Data := GetInt(pkt, 2);
            AddExData(' *— Idle time: ' + Format('%.02u:%.02u', [Data div 60, Data mod 60]));
          end;
          $0006:
          begin
           Dec(Pkt^.Len, TLVBlock.L);
           OnlineResult := OnlineResult + StatusToStr(StatusToInt(GetInt(pkt, 4)));
          end;
          $000f:
          begin
           Dec(Pkt.Len, TLVBlock.L);
           DateTime := GetInt(pkt, 4) / 86400;
           AddExData(' *— Online time: ' + IntToStr(Trunc(DateTime))+' day, ' + FormatDateTime('hh:nn:ss', DateTime));
          end;
        end;
      ...
      False:
        case TLVBlock.T of
          ...
          begin
            Dec(Pkt^.Len, TLVBlock.L);
            for j := 0 to (TLVBlock.L div 16) - 1 do
              OnlineResult := OnlineResult + HandleUUIDSet(GetStr(Pkt, 16));
          end;
        end;
    end;  
  end;

  procedure HandleSnac;
  var
    j: Word;
  begin
    for j := 0 to GetInt(Pkt, 2) - 1 do
      HandleTLVs(GetTLVBlock(pkt), True);
    if Pkt.Len < Flap.DataLen then
      while Pkt.Len < Flap.DataLen do
        HandleTLVs(GetTLVBlock(pkt), False);
   end;

begin
  if Flap.DataLen = 10 then                                     // "Colloquis")
  begin
    if Assigned(FOnUserInfoReply) then
      FOnUserInfoReply(Self, HiWord(Snac.ReqID), 0, '', '');
    Exit;
  end;

  if (Snac.Flags and  SNAC_HEADER_FLAGS_OPT_TLV_PRESENT) = SNAC_HEADER_FLAGS_OPT_TLV_PRESENT then
    Inc(Pkt^.Len, GetInt(Pkt, 1));
  ...
  if Assigned(FOnUserInfoReply) then
    FOnUserInfoReply(Self, LongRec(Snac.ReqID).Hi, 0, OnlineResult, ExData);
end;

procedure TICQClient.HandleSRV_LOCATE_ERR(Flap: TFlapHdr; Snac: TSnacHdr;
  Pkt: PRawPkt);
const
  SNAC_HEADER_FLAGS_OPT_TLV_PRESENT = $8000;
var
...
begin
  ...
  ECode := GetInt(pkt, 2);
  if Assigned(FOnUserInfoReply) then
    FOnUserInfoReply(Self, HiWord(Snac.ReqID), ECode, '', '');
end;

procedure TICQClient.HandleSRV_BUCP_CHALLENGE(Flap: TFlapHdr; Snac: TSnacHdr;
  Pkt: PRawPkt);
var
  _Pkt: TRawPkt;
begin
  CreateCLI_BUCP_QUERY(@_Pkt, FScreenName, FLPass, GetWStr(pkt), FSeq);
  FSock.SendData(_Pkt, _pkt.Len);
end;

procedure TICQClient.HandleSRV_BUCP_ERR(Flap: TFlapHdr; Snac: TSnacHdr;
  Pkt: PRawPkt);
var
  ErrorCode, ErrorSubCode: Word;
  ErrorUrl, ErrorMessage: string;
const
{
  int-l
  ErrorCategory_None = $00000000;
  ErrorCategory_Authorizer = $00000001;
  ErrorCategory_Disconnect = $00000002;
  ErrorCategory_Snac = $00000003;
  ErrorCategory_Socket = $00000004;
  ErrorCategory_FlapStream = $00000005;
  ErrorCategory_Connection = $00000006;
  ErrorCategory_Service = $00000007;
  ErrorCategory_Session = $00000008;
  ErrorCategory_Http = $00000009;
  ErrorCategory_Rendezvous = $0000000A;
  ErrorCategory_Security = $0000000B;
  ErrorCategory_Ocsp = $0000000C;
	ErrorCategory_TihConnection = $0000000D;
	ErrorCategory_ServiceTicket = $0000000E;
	ErrorCategory_DSP = $0000000F;
	ErrorCategory_RtavMp = $00000010;
  ErrorCategory_TihSession = $00000011;
	ErrorCategory_ConfDisconnect = $00000012;
}
   ...
   (*
      : ERROR_snac.c
   *)
  TSNACErrorCodes: array[1..31] of string =
    (
    'INVALID_SNAC',
    'RATE_TO_HOST',
    'RATE_TO_CLIENT',
    ...
    'IN_FREE_AREA',
    'RESTRICTED_BY_PC',
    'REMOTE_RESTRICTED_BY_PC'
    );
    
  procedure HandleTLVs(TLVBlock: TTLVBlock);
  begin
    if TLVBlock.L = 0 then Exit;
    case TLVBlock.T of
      $0004:
      begin
        Dec(Pkt^.Len, TLVBlock.L);
        ErrorUrl := GetStr(pkt, TLVBlock.L);
      end;
      $0008:
      begin
        Dec(Pkt^.Len, TLVBlock.L);
        ErrorSubCode := GetInt(pkt, TLVBlock.L);
      end;
      $001B:
      begin
        Dec(Pkt^.Len, TLVBlock.L);
        ErrorMessage := GetStr(pkt, TLVBlock.L);
      end;
    end;
  end;
...
begin
  ...
  while Pkt.Len < Flap.DataLen do
    HandleTLVs(GetTLVBlock(pkt));

  if ErrorCode in [Low(TSNACErrorCodes)..High(TSNACErrorCodes)] then
    OnIntError(nil, ERR_LOGIN, TSNACErrorCodes[ErrorCode])
  else
    OnIntError(nil, ERR_LOGIN, Format('auth_snac_error: 0x%.2x;0x%.2x;%s', [ErrorCode, ErrorSubCode, ErrorMessage]));
end;


procedure TICQClient.HandleSRV_BUCP_REPLY(Flap: TFlapHdr; Snac: TSnacHdr;
  Pkt: PRawPkt);
const
  TBUCPErrorCodes: array[1..42] of string =
    (
    'INVALID_NICK_OR_PASSWD (UNREGISTERED)',
    'SERVICE_TEMP_UNAVAIL',
    'ALL_OTHER_ERRORS',
    'INCORR_NICK_OR_PASSWORD',
    'MISMATCH_NICK_OR_PASSWD (MISMATCH HASH)',
    'BAD_INPUT',
    'INVALID_ACCT',
    'DELETED_ACCT',
    'EXPIRED_ACCT',
    ...
    'BAD_RESV_STATUS',
    'INTERNAL_ERROR',
    'SERVICE_TEMP_OFFLINE',
    'SUSPENDED_ACCT',
    'DB_SEND_ERR',
    'DB_LINK_ERR',
    'RESERVATION_MAP_ERR',
    'RESERVATION_LINK_ERR',
    'SAME_IP_CONNECTION',
    'SAME_IP_RESERVATION',
    'RESERVATION_RATE',
    'USER_TOO_EVIL',
...
var
  ...
  begin
    ...
    case TLVBlock.T of
      ...
      begin
        Dec(Pkt^.Len, TLVBlock.L);
        EUrlString := GetStr(pkt, TLVBlock.L);
      end;
      $0005:
      begin
          Dec(Pkt^.Len, TLVBlock.L);
          FData := GetStr(pkt, TLVBlock.L);
          InitNetICQ;
          FSock.Host := Copy(FData, 0, Pos(':', FData) - 1);
          FSock.Port := StrToInt(Copy(FData, Pos(':', FData) + 1, Length(FData) - Pos(':', FData)));
      end;
      ...
      begin
        Dec(Pkt^.Len, TLVBlock.L);
        FCookie := GetStr(pkt, TLVBlock.L);
      end;
      $0008:
      begin
        Dec(Pkt^.Len, TLVBlock.L);
        ErrorCode := GetInt(pkt, TLVBlock.L);
      end;
      $000c:
      begin
        Dec(Pkt^.Len, TLVBlock.L);
...
begin
  ...
  if (ErrorCode > 0) and (FData = '') then
  begin
    FSock.Host := '';
    if ErrorCode in [Low(TBUCPErrorCodes)..High(TBUCPErrorCodes)] then
      OnIntError(nil, ERR_LOGIN, TBUCPErrorCodes[ErrorCode])
    else
      OnIntError(nil, ERR_LOGIN, Format('auth_bucp_error: 0x%.2x;0x%.2x', [ErrorCode, ErrorSubCode]));
  end;
end;

procedure TICQClient.UserInfoQuery2(SN: string; const RequestId: Word);
var
  pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
  CreateCLI_LOCATE_USER_INFO_QUERY2(@pkt, SN, $00000001 or $00000002 or $00000004, RequestId, FSeq);
  FSock.SendData(pkt, pkt.Len);
end;

procedure TICQClient.HandleSRV_ICBM_ERR(Flap: TFlapHdr; Snac: TSnacHdr;
  Pkt: PRawPkt);
const
  SNAC_HEADER_FLAGS_OPT_TLV_PRESENT = $8000;
var
...
begin
  ...
  ECode := GetInt(pkt, 2);
  if Pkt.Len < Flap.DataLen then
    if GetInt(pkt, 2) = $0008 then                                    // TLV_TAGS_ERROR_SUBCODE
      SubECode := GetInt(pkt, GetInt(pkt, 2));

  if Assigned(FOnICBMReply) then
    FOnICBMReply(Self, HiWord(Snac.ReqID), ECode, SubECode);
end;

procedure TICQClient.ICBMQuery(SN: string; const RequestId: Word);
var
  Pkt: TRawPkt;
begin
  if not LoggedIn then Exit;
  CreateCLI_ICBM_CHANNEL_MSG_TOHOST(@Pkt, SN, RequestId, FSeq);
  FSock.SendData(pkt, pkt.Len);  
end;
